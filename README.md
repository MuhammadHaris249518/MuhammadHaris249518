...
AI-powered, community-verified food discovery platform for Islamabad & Rawalpindi. Production-grade MVP with a LangGraph ReAct agent, geo-filtered semantic search, and human-in-the-loop admin controls.

**Key Features:**
- LangGraph ReAct agent with HITL controls
...
5-component AI platform for students: career predictor, RAG chatbot (LLaMA 3 via Groq), resume analyser, study planner & resource recommender.
...
Secure, full-stack expense management app with categorised tracking and AI-generated summaries.

**Key Features:**
- LangChain-powered natural-language summaries
